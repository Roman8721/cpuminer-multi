...
static THREADLOCAL veltorhash_context_holder ctx;

void init_veltor_contexts(void *dummy)
{
...
int scanhash_veltor(int thr_id, uint32_t *pdata, const uint32_t *ptarget,
